   ...
   <!--
    ...
    <section class="ftco-section" id="body">
        <div class="container1">
          ...
          <div class="row">
            <div class="col-md-12">
              <h4 class="text-center mb-4">Johnson & Johnson Vaccine </h4>
              <br><br>
              <div class="table-wrap">
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      <th scope="row" class="scope" ><br>Johnson & Johnson</th>
                      ...
                      <td><br><button onclick="document.location='vaccineBatch.php?type=Johnson'">View Batches</button></td>
                    </tr>
