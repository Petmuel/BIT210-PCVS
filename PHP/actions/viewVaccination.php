<?php
    ...
    if (isset($_GET['submit'])){
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            echo '<script>window.location.href = "../vaccinationList.php";</script>';
            exit();
        }
        else{
            echo '<script>alert("Please select a vaccine batch before request");window.location.href = "../viewVaccination.php";</script>';
            exit();
        }    
